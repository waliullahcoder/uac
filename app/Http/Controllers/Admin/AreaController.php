...
class AreaController extends Controller
{
    ...
    {
        $this->path = 'area';
        $this->title = 'Area Setup';
        $this->create_title = 'Add Area';
        $this->edit_title = 'Update Area';
    ...
    {
        return HelperClass::resourceDataView($this->model::with(['region'])->orderBy('id', 'desc'), null, null, $this->path, $this->title, ['territories', 'clients']);
    }
    ...
    public function update(Request $request, string $id)
    {
        $request->validate([
            'region_id' => 'required',
            'name' => 'required',
            'code' => 'nullable|unique:areas,code,' . $id,
        ]);
