...
class MerchantOrderController extends Controller
{
    ...
    public function __construct(FrontEndService $adminService)
    {
        ...
        $this->title = 'Merchant Product Orders';
    ...
    public function index(Request $request)
    {
       ...
       $orders = $query->latest()->paginate(10)->withQueryString();
        ...
        return view('admin.merchant-order.orderList', compact('orders','title'));
    }
    ...
    {
        $title = $this->title;
        return view('admin.merchant-order.track', compact('order','title'));
    }
    ...
    public function show(Order $order)
    {
        ...
        $title = $this->title;
        return view('admin.merchant-order.show', compact('order','title'));
    }
    ...
    public function invoice(Order $order)
    {
        ...
        $title = $this->title;
        return view('admin.merchant-order.invoice', compact('order','title'));
    }
