    ...
    <div class="row g-3">
            ...
            <select name="cash_head" id="cash_head" class="form-select select" data-placeholder="select Cash Head" required>
                ...
                @foreach ($cashHeads as $item)
                    <option value="{{ $item->id }}"
                        {{ old('cash_head', $data->coa_id) == $item->id ? 'selected' : '' }}>
        ...
        <div class="col-md-4 col-sm-6">
            ...
            <textarea class="form-control remarks" id="remarks" name="remarks" rows="1" spellcheck="false"
                placeholder="Remarks">{{ old('remarks', $data->remarks) }}</textarea>
        </div>
        <div class="col-md-4 col-sm-6">
                        ...
                        @foreach ($data->items as $item)
                            <tr>
                                ...
                                <td class="py-1 px-3">
                                    ...
                                    <b class="head_name">{{ $item->coa->head_name ?? '' }} -
                                        {{ $item->coa->head_code ?? '' }}</b>
                                </td>
                                <td class="py-1">
                        ...
                        <tr>
                            ...
                            <td class="py-1">
                                <input type="number" step="any" class="totalDebit text-end form-control input-sm"
                                    id="totalDebit" name="totalDebit" value="{{ $data->amount }}" readonly>
                            </td>
                            <th></th>
                        </tr>
                    </tfoot>
