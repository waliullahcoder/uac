    ...
    <div class="row g-3">
        ...
        <div class="col-md-4 col-sm-6">
            ...
            <select name="collection_type" id="collection_type" class="select form-select" required>
                <option value="Payment" {{ old('collection_type') == 'Payment' ? 'selected' : '' }}>Invoice</option>
                <option value="Advance" {{ old('collection_type') == 'Advance' ? 'selected' : '' }}>Advance</option>
                <option value="Adjust" {{ old('collection_type') == 'Adjust' ? 'selected' : '' }}>Adjust</option>
            </select>
        </div>
        <div class="col-sm-6">
            <label for="remarks" class="form-label"><b>Remarks</b></label>
            <textarea class="form-control" name="remarks" id="remarks" cols="30" rows="1" placeholder="Remarks">{{ old('remarks') }}</textarea>
        </div>
        <div class="col-md-2 col-6">
            <label for="due" class="form-label"><b>Due</b></label>
            <input type="text" class="form-control" id="due" name="due" placeholder="Due" value="0"
                readonly>
        </div>
        <div class="col-md-2 col-6">
            <label for="advance" class="form-label"><b>Advance</b></label>
            <input type="text" class="form-control" id="advance" name="advance" placeholder="Advance" value="0"
                readonly>
        </div>
        <div class="col-md-2 col-sm-6">
            <label for="total_amount" class="form-label text-nowrap"><b>Total Collection</b></label>
            <input type="text" class="form-control" id="total_amount" name="total_amount" value="0"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function calculate() {
                ...
                if ($('.sales_id').length > 0 && $('.sales_id').length == $('.sales_id:checked')
                    .length) {
                    $('#checkAll').prop('checked', true);
                } else {
                    $('#checkAll').prop('checked', false);
