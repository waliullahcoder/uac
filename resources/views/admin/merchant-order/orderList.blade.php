            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h5 class="mb-0">🧾 Merchant's Product Orders</h5>
                    ...
                    <div class="table-responsive">
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                        ...
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('admin.merchant.orders.show',$order->id) }}" class="btn btn-outline-primary">👁</a>
                                            <a href="{{ route('admin.merchant.orders.invoice',$order->id) }}" class="btn btn-outline-success" target="_blank">📄</a>
                                            <a href="{{ route('admin.merchant.orders.track',$order->id) }}" class="btn btn-outline-warning">🔄</a>
                                            <!-- STATUS MODAL BUTTON -->
                        ...
                        <div class="modal fade" id="statusModal{{ $order->id }}" tabindex="-1">
                            <div class="modal-dialog modal-dialog-centered">
                                <form method="POST"
                                    action="{{ route('admin.merchant.orders.updateStatus', $order->id) }}"
                                    class="modal-content">
                                    @csrf
