                    ...
                    <div class="row g-2 g-md-3 g-lg-4">
                       @foreach($premium_courses as $desk)
                        <div class="col-6 col-lg-3 mt-4">
                            <div class="exam-package-area h-100 shadow-sm border rounded-3 overflow-hidden d-flex flex-column" style="background: #fff34a;transition: transform 0.2s ease, box-shadow 0.2s ease;">
                                ...
                                <div class="package-exam-content p-3 d-flex flex-column flex-grow-1 justify-content-between">
                                    ...
                                    <div class="package-exam-button mt-auto">
                                        <div class="package-exam-details">
                                            <a href="{{route('category.index',$desk->id)}}" class="btn btn-outline-primary btn-sm w-100 rounded-pill py-2 fw-medium" style="background: #b8ff12;font-size: 30px; letter-spacing: 0.5px;">
                                                বিস্তারিত <i class="fas fa-arrow-right ms-1" style="font-size: 30px;"></i>
                                            </a>
                                        </div>
                                    </div>
